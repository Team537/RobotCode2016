...
public:
	DriveTrain(Joystick* joystick, AnalogGyro* gyro) : IComponent(joystick, new string("DriveTrain")) //, Vision* visionTracking
	{
		...
		rightDrive2->SetControlMode(CANTalon::ControlMode::kPercentVbus);
		rightDrive2->EnableControl();

		rightDrive3 = new CANTalon(3);
		rightDrive3->SetControlMode(CANTalon::ControlMode::kPercentVbus);
		...
		leftDrive5->SetControlMode(CANTalon::ControlMode::kPercentVbus);
		leftDrive5->EnableControl();

		leftDrive6 = new CANTalon(6);
		leftDrive6->SetControlMode(CANTalon::ControlMode::kPercentVbus);
