...
void DriveTrain::Dashboard()
{
    ...
    SmartDashboard::PutNumber("Drive Right Output", rightDriveMaster->GetOutputVoltage());
    SmartDashboard::PutNumber("Drive Left Output", leftDriveMaster->GetOutputVoltage());
